...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    body:
      'Requested items will be prepared for pickup once a week (usually on Saturdays). You will receive an email to let you know when your items are ready. If you have not received a response within a week, please check your Spam or Junk email folder.',
  },
  {
    heading: 'How will I get my library items?',
    body:
      '<p>Your items will be placed in a labelled bag in the mailbox carousel in the church foyer, either in your mailbox or in one of the larger slots on the bottom. You will need to come into the church during office hours to pick them up.</p><br /><p>During times when we are able to meet in person for worship services, your items may also be left on your seat in the sanctuary.</p>',
  },
  {
    heading: 'How long can I keep my library items?',
    body:
      'Keep your items as long as you are making use of them. Just so we don’t lose track, we will send you a reminder if your items have not been returned after one month, and every 3 weeks after that.',
  },
  {
  ...
  },
  {
    ...
    body:
      '<p>When preparing items for pickup, the volunteer will be wearing a mask and cleaning their hands regularly.</p><p>Returned items will be ‘quarantined’ for about a week (at least 3 days) before being recirculated or reshelved.</p>',
  },
  {
